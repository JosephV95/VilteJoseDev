const dataJLV = {
    ...
    Mi enfoque está en el diseño web creativo y funcional. Disfruto enfrentar nuevos desafíos y cada línea de código que escribo refleja mi compromiso con el crecimiento y la mejora continua.</p>
    <p><i>Estoy aquí para ayudarte a dar vida a tus proyectos con profesionalismo y creatividad. Si necesitas un colaborador apasionado y dedicado, ¡no dudes en contactarme!</i></p>
    `,
    educación: [
      { 
